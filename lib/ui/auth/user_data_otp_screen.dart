...
class UserDataOtpScreen extends StatefulWidget {
  static String routeName = "/user_data_otp_screen";

  @override
  _UserDataOtpScreenState createState() => _UserDataOtpScreenState();
}

class _UserDataOtpScreenState extends State<UserDataOtpScreen> {
  ...
  getAuthData() {
    ...
    setState(() {
      handphoneController.text = authData.phoneNumber;
    });
  }
